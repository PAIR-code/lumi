...
"""
    ...
    def test_postprocess_span_text(self):
        with self.subTest("test_unescape_dollar"):
            ...
            self.assertEqual(markdown_utils.postprocess_span_text(text_input), expected)
        ...
        with self.subTest("test_no_special_chars"):
            ...
            self.assertEqual(
                markdown_utils.postprocess_span_text(text_input), text_input
            )
